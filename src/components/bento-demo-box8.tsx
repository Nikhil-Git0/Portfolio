      ...
      >
        ...
        <div className="space-y-4">
          ...
          {/* <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            <li>Certificate 1: React Developer Certification - 2023</li>
            <li>Certificate 2: AWS Certified Solutions Architect - 2022</li>
            <li>Certificate 3: Google UX Design Professional Certificate - 2021</li>
          </ul>
          <p className="text-gray-700 dark:text-gray-300">
            These certificates showcase my expertise in various technical domains.
          </p> */}
        </div>
      </div>
    </div>,
...
export default function BentoDemoBox8() {
